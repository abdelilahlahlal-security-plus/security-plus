...
export function Hero({ data }: HeroProps) {
    return (
        <div className="relative pt-[176px] pb-24 lg:pt-[208px] lg:pb-32 flex items-center justify-center overflow-hidden bg-primary dark:bg-black transition-colors duration-500">
            {/* Background Image */}
